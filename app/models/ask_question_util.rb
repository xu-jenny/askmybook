class AskQuestionUtil
    ...
    def self.construct_promopt(question, embedding, question_embedding)
    ...
    def self.order_context_by_query_similarity(question_embedding, context)
    ...
    def self.choose_sections(embedding, most_relevant_context)
