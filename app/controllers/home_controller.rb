class HomeController < ApplicationController
    ...
    def ask
        ...
        Thread.start {
            ...
            # we can also do a vecotry_similiary comparison of this answer with answers in db 
            # and add the question as a similiarq if similiarity is greater than some threshold to save api calls
        }
